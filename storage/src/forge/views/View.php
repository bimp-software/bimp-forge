...
class View {
     ...
     * @var string
     */
    private $templateEngine = 'forge'; // forge | twig
     ...
     * @return void
     */
    function renderForgeTemplate(string $view, array $data = []) {
    ...
    {
        ForgeHookManager::runHook('on_get_twig_filters', $this->twigIntance); // Permite registrar nuevos filtros
    ...
    function getTwigFunctions() {
        ForgeHookManager::runHook('on_get_twig_functions', $this->twigIntance); // Permite registrar nuevas funciones
    ...
    public static function render(string $view, array $data = [], ?string $templateEngine = null)
    {
        ...
        switch ($engine->templateEngine) {
            ...
            case 'forge':
                    $engine->renderForgeTemplate($view, $data);
                break;
